...
public class Funciones {
    ...
    public static final String NOMBRE_SOFTWARE = "SISTEMA PARA RESTAURANTE ― ACDC S.A.";
  ...
  public static void llenarTablaBusquedaBYoscar(JTable tabla, ResultSet resultado, String valor) throws Exception{
        ...
        while (resultado.next()){
            ...
            if (! valor.isEmpty()){
              if ((resultado.getObject("codigo_articulo").toString().toLowerCase().contains(valor.toLowerCase()))||
                    (resultado.getObject("nombre").toString().toLowerCase().contains(valor.toLowerCase()))||
                      (resultado.getObject("precio_venta").toString().toLowerCase().contains(valor.toLowerCase()))||
                      (resultado.getObject("presentacion").toString().toLowerCase().contains(valor.toLowerCase()))||
                      (resultado.getObject("linea").toString().toLowerCase().contains(valor.toLowerCase()))||
                      (resultado.getObject("categoria").toString().toLowerCase().contains(valor.toLowerCase()))){
                    modelo.addRow(datos);
                }
            }else{
                modelo.addRow(datos);
    ...
    public static void llenarTablaBusquedaByoscar(JTable tabla, ResultSet resultado, int[] anchoColumna, String[] alineacionColumna, String valor) throws Exception{
        llenarTablaBusquedaBYoscar(tabla, resultado, valor);
